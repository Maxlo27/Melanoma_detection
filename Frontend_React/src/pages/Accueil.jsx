            ...
            <div className={styles.conteneurAccueil1}>
                ...
                <div className={styles.gridcontainer}>
                    <div className={styles.item1}>
                        ...
                        <div className={styles.resultPreduc}>{newPourcentageBenin} % Bénin</div>
                        <div className={styles.resultPreduc}>{newPourcentageMalin} % Maligne</div>
                    </div>
